...
namespace Engine
{
    ...
    class RotatingSpriteGameObject : SpriteGameObject
    {
        ...
        public RotatingSpriteGameObject(string assetname, float depth = 0, int sheetIndex = 0) :
            base(assetname, depth, sheetIndex)
        {
        }
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(sprite.GetTexture, GlobalPosition, null, Color.White, radians - MathHelper.ToRadians(offsetDegrees), Origin, scale, SpriteEffects.None, 0);
        }
