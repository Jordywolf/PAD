    ...
    class NewGameState : GameState
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.Space) && Game1.framecount > Game1.startframe + 10)
            {
                ...
                Game1.GameStateManager.SwitchTo("introGameState", "jogonLevelPlayingState", new GameStates.JogonLevelPlayingState(Game1.jogonSound, Game1.Player, Game1.jogonFightSound));
                Game1.framecount = Game1.startframe;
            }
        }
